...
class sgs(imdb):
    ...
    def gt_roidb(self):
        ...
        gt_roidb = [self._load_sgs_annotation(index)
    ...
    def _load_sgs_annotation(self, index):
        """
    ...
    def _write_sgs_results_file(self, all_boxes):
    ...
    def evaluate_detections(self, all_boxes, output_dir):
        comp_id = self._write_sgs_results_file(all_boxes)
